...
public class EditorActivity extends AppCompatActivity implements
    ...
    /**
     * EditText field to enter the product's supplier contact number
     */
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mQuantityEditText = (EditText) findViewById(R.id.edit_prod_quantity);
        mSupplierEditText = (EditText) findViewById(R.id.edit_product_supplier_name);
        mNumberEditText = (EditText) findViewById(R.id.edit_product_supplier_number);
        ...
        callSupplier = findViewById(R.id.contact_supplier);
    ...
    private void saveProduct() {
        ...
        // integer value. Use 88884444 by default.
        int number = 88884444;
        if (!TextUtils.isEmpty(numberString)) {
            number = Integer.parseInt(numberString);
        }
        values.put(ProductEntry.COLUMN_PRODUCT_NUMBER, number);
    ...
    public void onLoadFinished(Loader<Cursor> loader, Cursor cursor) {
        ...
        if (cursor.moveToFirst()) {
            ...
            int numberColumnIndex = cursor.getColumnIndex(ProductEntry.COLUMN_PRODUCT_NUMBER);
    ...
    public void onLoaderReset(Loader<Cursor> loader) {
        ...
        mQuantityEditText.setText("0"); // Select "0" quantity
    }
    ...
    public void onClick(View v) {
        ...
        int quantity = Integer.valueOf(mQuantityEditText.getText().toString().trim());
        switch (v.getId()) {
            ...
            case R.id.decrease_quantity_button:
                if (quantity > 0) {
                    ...
                    mQuantityEditText.setText("0");
                    Toast.makeText(this, "Quantity cannot be decreased further!", Toast.LENGTH_SHORT).show();
                }
                break;
            case R.id.contact_supplier:
                String supplier_number = mNumberEditText.getText().toString().trim();
